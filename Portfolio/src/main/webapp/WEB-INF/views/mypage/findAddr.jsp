...
<script type="text/javascript">
	function confirm(postNum, sido, gugun, dong) {
		opener.document.order.postNum.value=postNum;
		opener.document.order.addr1.value=sido+" "+gugun+" "+dong;
		self.close();
		return;
	}
</script>
...
<div align="center">
<h3>주소 변경</h3>
  <form class="form_inline" action="change_addr" method="post" name="sign">
