...
<body>
    ...
    <br><br>
            <div>
                <span><h3>이용 후기</h3></span>
            </div>
            <hr>
           <div class="input-group mb-3">
			  <textarea  class="form-control" placeholder="이용후기 입력하세요" id="content" name="content"></textarea>
			  <div class="input-group-append">
			    <button class="btn btn-success" type="button" id="button-addon2" onClick="save_room_comment('${room.roomNum }')">&nbsp;&nbsp;등록&nbsp;&nbsp;</button>
			  </div>
			</div>
        </div>
...
// 상품평 목록 불러오기
function getRoomCommentList(){
	$.ajax({
		type: 'GET',
		url: 'comment_room_list',
		dataType: "json",
		...
		success: function(data){
			...
			if(cCnt > 0){
				...
				html += "<div>";
				html += "<div><h6>등록된 이용후기가 없습니다.</h6></div>";
				html == "</div>";
			}
